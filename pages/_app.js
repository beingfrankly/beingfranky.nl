...
function MyApp({ Component, pageProps }) {
  return (
    <>
      <Head>
          <meta name="description" content="Making accessibility (a11y) more accessible for frontend developers."/>
          <meta property="og:title" content="BeingFrankly"/>
          <meta property="og:description" content="Making accessibility (a11y) more accessible for frontend developers."/>
