...
export default function Layout({ children }) {
  return (
    <>
      ...
      <footer>
        <p>© 2021-present Frank van Eldijk-Smeding. All Rights Reserved.</p>
        <span className="social-links">
          <a href="https://twitter.com/frankvaneldijk" target="_blank" rel="noopener noreferrer" aria-label="twitter">
          ...
          <a href="https://github.com/beingfrankly" target="_blank" rel="noopener noreferrer" aria-label="github" >
          ...
          <a href="https://nl.linkedin.com/in/frankvaneldijk" target="_blank" rel="noopener noreferrer" aria-label="linkedin">
